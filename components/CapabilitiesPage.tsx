                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-4 sticky top-40 h-fit">
                        ...
                        <div className="bg-brand-black text-white p-8 rounded-2xl relative overflow-hidden">
                            ...
                            <button onClick={() => navigateTo('contact')} className="inline-block border border-white/30 rounded-full px-6 py-2 hover:bg-white hover:text-black transition-colors font-mono text-xs uppercase">
                                Book a Call
                            </button>
                        </div>
                    </div>
